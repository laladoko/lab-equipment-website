  ...
  const contactInfo = [
    {
      icon: Phone,
      title: '热线电话',
      content: '0571-89988123 / 13305715395',
      subtitle: '7×24小时服务热线'
    },
    {
      icon: Mail,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="bg-blue-25 rounded-2xl p-8"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-lg font-semibold text-lg flex items-center justify-center hover:shadow-lg transition-all duration-300"
              >
