...
export const fritschProducts: FritschProduct[] = [
  ...
  {
    id: 5,
    name: 'PULVERISETTE 23 微型行星式高能球磨机（加强型）',
    category: '微型球磨机',
    image: '/brands/fritsch/pulverisette23-micro-planetary-ball-mill.jpg',
    description: 'FRITSCH PULVERISETTE 23 微型行星式高能球磨机（加强型），极高速研磨至纳米范围，研磨碗转速可达2200转/分钟，采用自锁革新技术的沉降式研磨碗。',
    features: ['极高速研磨至纳米范围', '研磨碗转速可达2200转/分钟', '采用自锁革新技术的沉降式研磨碗', '无额外张力，避免误操作', '自动检验研磨机中的研磨碗锁定情况', '研磨碗配备革新型ServoLOCK锁定机制', '可实现前所未有地安全研磨', '无需额外夹紧且不会有错误操作的风险', '通过RFID芯片可智能化识别研磨碗', 'MillControl软件可自动控制研磨机及验证研磨状态', '行星式球磨机PULVERISETTE 5加强型获德国专利局授予的5项专利'],
    price: '询价',
    link: 'https://www.fritsch.de/cn/sample-preparation/milling/planetary-mills/pulverisette-23/',
    officialLink: 'https://www.fritsch.de/cn/sample-preparation/milling/planetary-mills/pulverisette-23/',
    specifications: {
      '研磨碗容量': '10-80ml',
      '最大样品进料量': '2×5ml',
      '研磨球直径': '0.1-15mm',
